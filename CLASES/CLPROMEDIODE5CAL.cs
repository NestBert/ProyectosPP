...
namespace ProyectosPP.CLASES
{
    class CLPROMEDIODE5CAL
    {
        ...
        public CLPROMEDIODE5CAL(double calificacion1, double calificacion2, double calificacion3, double calificacion4, double calificacion5)
        {
        ...
        public double calculodelpromedio()
        {
